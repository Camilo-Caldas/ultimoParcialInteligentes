...
model.add(Conv2D(kernel_size=3, strides=1, filters=8, padding="same", activation="relu", name="capa_1"))
...
model.fit(x=imagenes, y=probabilidades, epochs=10, batch_size=256)

ruta = "models/modeloCuatro.h5"
model.save(ruta)
model.summary()
