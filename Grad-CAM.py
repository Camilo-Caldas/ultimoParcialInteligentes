...
#se normaliza el mapa de calor entre 0 y 1 y se devuelve como un array NumPy.
...
preds = model.predict(img_array)   #Realizar predicciones y mostrar la clase predicha:
print("Predicted:", decode_predictions(preds, top=1)[0])

# Generate class activation heatmap
heatmap = make_gradcam_heatmap(img_array, model, last_conv_layer_name)  #Generar el mapa de activación Grad-CAM:
